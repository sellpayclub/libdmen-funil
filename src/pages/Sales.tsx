  ...
  return (
    <div className="min-h-screen bg-stone-50 pb-20 font-sans">
      ...
      <div className="max-w-5xl mx-auto px-0 sm:px-6 pt-10">
        ...
        <div className="bg-white px-4 py-8 sm:p-12 mb-16 relative sm:rounded-3xl sm:shadow-xl sm:shadow-stone-200/50 border-y sm:border border-stone-100 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex justify-center mb-4 sm:mb-6 w-full">
              <img src="https://xyzgvsuttwrvbyyxdppq.supabase.co/storage/v1/object/public/imagens/pote.png" alt="Produto LibidMen" className="w-full max-w-[320px] sm:max-w-sm drop-shadow-2xl" />
            </div>
            
            <p className="text-stone-600 mb-6 sm:mb-8 text-center md:text-left text-lg">Com base nas suas respostas, o sistema científico identificou o protocolo exato para reativar seu fluxo sanguíneo:</p>
        ...
        {/* Pricing Table / Kits */}
        <div className="grid lg:grid-cols-3 gap-8 sm:gap-8 items-end mb-24 max-w-md lg:max-w-none mx-auto px-4 sm:px-0 mt-4">
          ...
          <div className="bg-white rounded-[2.5rem] shadow-xl shadow-stone-200/50 border border-stone-100 overflow-hidden flex flex-col group relative">
             ...
             <div className="p-6 bg-white">
               <a href="https://seguro.vitago-suplements.shop/r/70ME8V8Q78" target="_blank" rel="noopener noreferrer" onClick={() => trackEvent(FunnelEvent.CHECKOUT_CLICK, "Kit 1 mês")} className="flex items-center justify-center gap-2 w-full text-center bg-stone-900 hover:bg-black text-white font-black py-4 rounded-xl shadow-lg shadow-stone-900/20 transition-all text-lg uppercase tracking-wide">
                 Comprar Agora
               </a>
             </div>
          </div>
          ...
          {/* Kit 3 (Most Popular) */}
          <div className="bg-white rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(220,38,38,0.4)] border-[5px] border-red-600 overflow-hidden flex flex-col relative z-20 transform lg:-translate-y-4">
             <div className="absolute top-0 inset-x-0 bg-gradient-to-r from-red-600 to-red-700 text-white text-center py-3 font-black text-[13px] sm:text-sm tracking-widest uppercase shadow-md leading-relaxed px-2">
               ESTE É O KIT MAIS RECOMENDADO MUNDIALMENTE
             </div>
             <div className="p-8 text-center pt-20 bg-stone-50/50">
                <h3 className="text-3xl sm:text-4xl font-black font-heading text-stone-900 mb-2">Kit 3 Meses</h3>
                <div className="mb-6">
                ...
                <div className="h-64 sm:h-72 bg-white rounded-2xl mb-6 p-2 flex items-center justify-center shadow-sm border border-stone-100">
                ...
                <p className="text-base sm:text-lg text-stone-700 font-bold mb-4 bg-red-100/50 rounded-lg py-3 border border-red-100">
                  Apenas R$ 65,66 por frasco!
                </p>
             </div>
             <div className="p-8 sm:pb-10 bg-white">
               <a href="https://seguro.vitago-suplements.shop/r/L2JD6XGPTC" target="_blank" rel="noopener noreferrer" onClick={() => trackEvent(FunnelEvent.CHECKOUT_CLICK, "Kit 3 meses")} className="flex flex-col items-center justify-center w-full text-center bg-gradient-to-b from-green-500 to-green-700 hover:from-green-600 hover:to-green-800 text-white font-black py-5 sm:py-6 rounded-2xl shadow-[0_10px_20px_-10px_rgba(22,163,74,0.6)] hover:shadow-[0_15px_30px_-10px_rgba(22,163,74,0.8)] transition-all uppercase tracking-wider scale-100 hover:scale-[1.02] active:scale-[0.98]">
                 <span className="text-lg sm:text-xl md:text-2xl">GARANTIR MEU KIT 3 MESES!</span>
          ...
          <div className="bg-white rounded-[2.5rem] shadow-xl shadow-stone-200/50 border border-stone-100 overflow-hidden flex flex-col group relative">
             ...
             <div className="p-8 bg-white">
               <a href="https://seguro.vitago-suplements.shop/r/5NKDYAECY1" target="_blank" rel="noopener noreferrer" onClick={() => trackEvent(FunnelEvent.CHECKOUT_CLICK, "Kit 6 Meses")} className="flex items-center justify-center gap-2 w-full text-center bg-stone-900 hover:bg-black text-white font-black py-4 rounded-xl shadow-lg shadow-stone-900/20 transition-all text-lg uppercase tracking-wide">
                 Comprar Kit 6 Meses
               </a>
             </div>
          </div>
        ...
        <div className="mb-24 relative overflow-hidden">
          ...
          <div className="relative">
             <div ref={carouselRef} className="flex overflow-x-auto gap-4 sm:gap-6 pb-12 snap-x snap-mandatory hide-scrollbars px-4 sm:px-10">
